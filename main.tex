...
\begin{itemize}
  \item [\emph{H\'ebergement}] \ifthenelse{\NBLITS>0}{\emph{\NBLITS{}
      lit\ifthenelse{\NBLITS>1}{s}{}} pour \emph{\NUITS{}
      nuit\'ee\ifthenelse{\NUITS>1}{s}{}}}{pas de prise en charge},
    ...
    \ifthenelse{\NBREPAS>0}{\emph{\NBREPAS{}} repas
      ...
      (entr\'ee, plat principal, fromage, dessert, boissons) sur
      \emph{\JOURS{}} jour\ifthenelse{\JOURS>1}{s}{}}{pas de prise en
      charge}\footnotetext[1]{selon les conditions de caterings :
      v\'eg\'etarien},
  \item [\emph{Transports}] \ifthenelse{\PRIXTRANSP>0}{location de
    voiture + frais d'esssence et de p\'eage aller/retour pour le
    trajet \emph{\PRIXTRANSP{} \euro}}{pas de prise en charge}.
\end{itemize}
