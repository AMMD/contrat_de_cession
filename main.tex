...
pr\'e-cit\'e, le \emph{\DATEREP{}} \`a \emph{\HEUREREP{}}\COMPLEMENTREP{}.
...
l'Art. \vref{sec:heb_rest_transp} du pr\'esent contrat.

\subsection{Conditions techniques}
\label{sec:oblig_pr:sub:cond_techniques}
\PR\ fournira en annexe \vref{sec:techband} du pr\'esent contrat un avenant pr\'ecisant
...
sur la sc\`ene ou sur les enceintes de diffusion.
...
\begin{itemize}
    ...
    \ifthenelse{\NBREPAS>0}{\emph{\NBREPAS{}} repas
      chaud\ifthenelse{\NBREPAS>1}{s}{}
      complet\ifthenelse{\NBREPAS>1}{s}{}
      végétarien\ifthenelse{\NBREPAS>1}{s}{} par personne (\NBBANDPERS{}
      personne\ifthenelse{\NBBANDPERS>1}{s}{}) (entr\'ee, plat
      principal, fromage, dessert, boissons) sur \emph{\JOURS{}}
      jour\ifthenelse{\JOURS>1}{s}{}}{pas de prise en charge},
...
\item Demandeurs d'emploi : \emph{\PRIXDEMANDEURSEMPLOI{} \euro}
\end{itemize}
...
sur pr\'esentation de facture, une somme totale de \emph{\PRIXPRESTA{} \euro} net de taxes.

\section{Modalit\'es de paiement}
\label{sec:modalite_paiement}
Le r\`eglement des sommes pr\'evues \`a l'Art. \vref{sec:prix_presta} sera
effectu\'e \ifthenelse{\equal{\PAIEMENTPRESTA}{cheque}}{le jour du spectacle avant la repr\'esentation par ch\`eque bancaire ou postal}{\PAIEMENTPRESTA{}}.
...
convenu que les boissons pourront \^etre pr\'ef\'erablement vendues dans
des verres en plastique ou carton, et \`a d\'efaut dans des bo\^ites ou
des canettes en verre ou m\'etal. Par ailleurs, \OR\ d\'ecidera du lieu
